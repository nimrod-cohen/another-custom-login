			...
			<table class="form-table">
				<tbody>
					<tr>
						...
						<td>
							<select id="login_page" name="login_page" class="regular-text">
					...
					<tr>
						...
						<td>
							<select id="login_by" name="login_by" class="regular-text">
					...
					<tr>
						...
						<td>
							<select id="pass_strength" name="pass_strength" class="regular-text">
				...
				<tbody>
					...
					foreach ( $roles as $role => $details ) {
						...
						<tr>
							...
							<td>
								<select class="regular-text" id="ral_<?php echo $role; ?>" name="ral_<?php echo $role; ?>">
